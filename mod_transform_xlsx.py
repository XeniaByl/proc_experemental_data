...
#строит графики с заданным названием с отсечкой по RMSE, удаляет area3
...
#%% построение графиков по всем xlsx файлам из указанной папки root_path
def all_plots_one_folder (root_path, rmse):
    import re
    import pandas as pd
    import pathlib
...
focus_group = ['Rat12', 'Rat13', 'Rat14', 'Rat15', 'Rat32', 'Rat33',\
          'Rat34', 'Rat35']                 
all_plots_one_folder (root_path, rmse=0.051)               
    
#%%520-580, пример использования для одного диапазоно
